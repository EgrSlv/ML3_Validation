...
Существует частный случай кросс-валидации, называемый **`leave-one-out validation scheme`** (схема кросс-валидации с исключением одного элемента). Вам предстоит найти определение этой схемы, а также указать ее ограничения и сильные стороны.
